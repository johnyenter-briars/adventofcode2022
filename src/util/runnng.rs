...
use crate::{
    ...
    day3::rucksack::{sum_of_priorities_of_each_group_part2, sum_of_priorities_part1}, day4::campcleanup::{overlapping_full_pairs_part1, overlapping_part_of_pairs_part2},
};
...
fn day4() -> Vec<(&'static str, Result<i32, Box<dyn Error>>)>{
    ...
    vec![
        ("The number of pairs in which one contains the other is: ", overlapping_full_pairs_part1(path)),
        ("The number of pairs in which any element overlaps is: ", overlapping_part_of_pairs_part2(path)),
    ]
}